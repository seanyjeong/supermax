...
async function updateJungsiData() {
  try {
    ...
    const response = await axios.get(https://script.google.com/macros/s/AKfycbywMU0RrAnT5SDr9wqgmuhOuO_TCPqQ28tE-wFmxFJgJP-tVqmSU-EKEWq0n5_IbaZE/exec); // Google Apps Script 웹앱 URL
