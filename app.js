...
app.post('/save-data', (req, res) => {
  const { formType, name, academy, gender, scores, academicScore, totalScore, practicalTotal } = req.body;

  let query = `
    INSERT INTO student_scores 
    (form_type, name, academy, gender, standing_jump, weighted_run, back_strength, sit_and_reach, academic_score, total_score, practical_total)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `;

  let values = [formType, name, academy, gender, scores.standingJump, scores.weightedRun, scores.backStrength, scores.sitAndReach, academicScore, totalScore, practicalTotal];
